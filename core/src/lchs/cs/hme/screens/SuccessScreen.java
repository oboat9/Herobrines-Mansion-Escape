...
public class SuccessScreen implements Screen {
	...
	private static final int OK_BUTTON_Y = 115;
	...
	public SuccessScreen (HerobrineEscape game) {
		this.game = game;
		...
		wallpaper = new Texture("images/titles/winscreen.png");
		
		clickSound = Gdx.audio.newSound(Gdx.files.internal("sounds/buttonclick.wav"));
		
		winMusic = Gdx.audio.newMusic(Gdx.files.internal("sounds/victorymusic.wav"));
